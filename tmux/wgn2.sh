...
tmux send-keys -t wgn1 'cd ~/workspace/full_web2' C-m
tmux split-window -h -t wgn1

tmux send-keys -t wgn1 'cd ~/workspace/full_web2/wgnp/trunk' C-m
...
tmux send-keys -t wgn1 'cd ~/workspace/full_web2/wgni/trunk' C-m
...
tmux send-keys -t wgn1 'cd ~/workspace/full_web2/wgnr/trunk' C-m
